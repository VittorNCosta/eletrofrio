...
Modelo leve: só o necessário para o fluxo de análise + abertura de chamado.
"""
...
class AgentDecision(BaseModel):
    ...
    action: str    # "direct_response" | "rag_lookup" | "open_ticket"
    reason: str
    rag_recommendation: Optional[str] = None
    ticket_opened: bool = False
    ticket_response: Optional[dict[str, Any]] = None
